...
function TwilioConnector(settings) {
    ...
    var accountSidProper = this.accountSidProper = settings.accountSidProper;
    var options = {};
    if (accountSidProper) { options.accountSid = accountSidProper; }

    twilio = connector.twilio = require('twilio')(accountSid, authToken, options);
